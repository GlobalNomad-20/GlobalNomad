...
const Activities = () => {
  return (
    <div className="bg-white">
      <section
        className="relative h-[800px] bg-linear-to-b from-[#BBDDFF] via-[#F7FBFF] to-white
          md:h-[1250px]"
      >
        <div className="absolute top-0 left-0 z-0 h-35 w-full md:h-70 lg:h-105">
          <Image
            src="/image/cloud.svg"
            alt="구름"
            fill
            className="absolute bottom-6 left-0 z-0 w-[200vw] max-w-none opacity-90 md:w-[1600px]"
          />
        </div>
        <div
          className="relative z-10 flex flex-col items-center justify-center pt-[74px] pb-34
            md:pt-[103px] md:pb-[204px] lg:pb-[218px]"
        >
          <Banner />
          <div
